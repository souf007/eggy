				...
				<div class="lx-main-content">
					<div class="lx-page-header">
						<nav class="breadcrumb">
							<span class="breadcrumb-item active"><i class="fas fa-file-invoice"></i> Factures avoir</span>
						</nav>
					</div>
					...
					<div class="lx-tabs">
						...
						if(preg_match("#Consulter Factures avoir#",$_SESSION['easybm_roles'])){	
							?>
						<a href="avoirs.php" class="active">Factures avoir</a>
							<?php
						}
						...
						<div class="lx-g1">
							<div class="lx-add-form">
								...
								if(preg_match("#Ajouter Factures avoir#",$_SESSION['easybm_roles'])){	
									?>							
								<a href="javascript:;" class="lx-new lx-new-command lx-open-popup" data-header="Ajouter un nouvelle" data-table="avoirs" data-title="command">+ Nouvelle facture avoir</a>
									<?php
								}					
								?>						
							</div>
							<div class="lx-keyword">
								<fieldset style="margin-bottom:20px;padding:10px;background:#F8F8F8;">
									...
									<label><a href="javascript:;" class="lx-search-keyword"><i class="fa fa-search"></i></a><input type="text" autocomplete="off" name="keyword" id="keyword" placeholder="Réf facture avoir" data-table="avoirs" /></label>
									<?php
									$styleday = "";
									$rangedate = "";
									...
									<label class="lx-advanced-select">
										<i class="fa fa-caret-down"></i>
										<input type="text" autocomplete="off" name="state" id="state" title="État de paiement" value="<?php echo isset($_GET['paid'])?$_GET['paid']:"";?>" placeholder="État de paiement" data-ids="<?php echo isset($_GET['paid'])?$_GET['paid']:"";?>" readonly />
										<div>
											<a href="javascript:;" class="lx-state-empty">Vider</a>
											<a href="javascript:;" class="lx-state-filter">Filtrer</a>
											<div class="lx-clear-fix"></div>
											<input type="text" autocomplete="off" name="searchadvanced" style="margin-bottom:20px;" />
											<ul>
												<li><label><input type="checkbox" value="Remboursée" data-ids="Remboursée" /> Remboursée<del class="checkmark"></del></label></li>
												<li><label><input type="checkbox" value="Partiellement remboursée" data-ids="Partiellement remboursée" <?php echo isset($_GET['paid'])?(preg_match("#Partiellement remboursée#",$_GET['paid'])?"checked":""):"";?> /> Partiellement remboursée<del class="checkmark"></del></label></li>
												<li><label><input type="checkbox" value="Non remboursée" data-ids="Non remboursée" <?php echo isset($_GET['paid'])?(preg_match("#Non remboursée#",$_GET['paid'])?"checked":""):"";?> /> Non remboursée<del class="checkmark"></del></label></li>
											</ul>
										</div>
									</label>
									<label class="lx-advanced-select">
									...
									<label>
										<a href="avoirs.php" class="lx-refresh-filter" style="margin-left:10px;"><i class="fa fa-sync-alt"></i></a>
									</label>
								</fieldset>
							</div>
							<div class="lx-table-container">
								...
								<div class="lx-table lx-table-avoirs">
							...
							<div class="lx-action-bulk">
								<?php
								if(preg_match("#Exporter Factures avoir#",$_SESSION['easybm_roles'])){
								?>
							...
							<div class="lx-pagination" style="<?php if($row['nb'] <= $nb){echo "display:none;";}?>">
								...
								?>
								<ul data-table="avoirs" data-state="1" data-start="0" data-nbpage="<?php echo $nb;?>" data-posts="<?php echo $row['nb'];?>">
								...
								<div class="lx-add-form">
									<form autocomplete="off" action="#" method="post" id="commandsform">
										...
										<div class="lx-textfield lx-g2 lx-pb-0 lx-cash">
											<label><span>Montant remboursé<sup>*</sup>: </span><input type="text" autocomplete="off" name="cash" data-isnumber="" data-message="Saisissez un montant!!" /></label>
										</div>
										<div class="lx-textfield lx-g2 lx-pb-0 lx-cash">
										...
										<div class="lx-submit lx-g1 lx-pb-0">
											...
											<input type="hidden" name="prefix" value="AV" />
							...
							<div class="lx-form">
								...
								<div class="lx-add-form">
									<form autocomplete="off" action="#" method="post" id="extrainfoform">
										...
										<div class="lx-clear-fix"></div>
										<div class="lx-textfield lx-g1 lx-pb-0">
											<label><span>Mode de remboursement (au-dessous du tableau): </span><textarea name="modepayment" id="modepayment" /></textarea></label>
										</div>
										<div class="lx-clear-fix"></div>
										<div class="lx-textfield lx-g1 lx-pb-0">
				...
				<div class="lx-popup-inside">
					<div class="lx-popup-content">
						...
						<div class="lx-popup-details">
							<div class="lx-form">
								<div class="lx-form-title">
									<h3>Remboursement facture avoir</h3>
								</div>
								<div class="lx-add-form">
									<form autocomplete="off" action="#" method="post" id="paymentform">
										<div class="lx-textfield lx-g1 lx-pb-0">
											<h3 style="margin-bottom:0px;text-align:center;text-decoration:underline;">Historique des remboursement</h3>
										</div>
										<div class="lx-clear-fix"></div>
										<div class="lx-textfield lx-g1 lx-pb-0">
											<div class="lx-table">
										...
										<div class="lx-clear-fix"></div>
										<div class="lx-textfield lx-g1 lx-pb-0">
											<a href="javascript:;" class="lx-payment-state" data-paid="Non remboursée" style="display:none;font-weight:500;background:#CC0000;color:#FFFFFF;">Non remboursée</a>
											<a href="javascript:;" class="lx-payment-state" data-paid="Partiellement remboursée" style="font-weight:500;background:orange;color:#FFFFFF;">Partiellement remboursée</a>
											<a href="javascript:;" class="lx-payment-state" data-paid="Remboursée" style="font-weight:500;background:#71b44c;color:#FFFFFF;">Remboursée</a>
										...
										<div class="lx-clear-fix"></div>
										<div class="lx-textfield lx-g2 lx-pb-0 lx-cheque" style="display:none;">
											<label><span>Date d'écheance: </span><input type="text" name="dateduecommand" /></label>
										</div>
										<div class="lx-textfield lx-g2 lx-pb-0 lx-cheque" style="display:none;">
											<label><span>Date décaissement (Rapprochement): </span><input type="text" name="datepaidcommand" /></label>
										</div>
										<div class="lx-clear-fix"></div>
										<div class="lx-textfield lx-g2 lx-pb-0">
											<label><span>Imputation comptable:</span>
							...
							<div class="lx-form">
								...
								<div class="lx-add-form">
									<form autocomplete="off" action="#" method="post" id="exportform">
										...
										<div class="lx-clear-fix"></div>
										<div class="lx-textfield lx-g1 lx-pb-0">
											<label><input type="checkbox" name="columns" value="correctdoc" data-title="Corrige la facture N°" checked /> Corrige la facture N°<del class="checkmark"></del></label>
										</div>
										<div class="lx-clear-fix"></div>
										<div class="lx-textfield lx-g1 lx-pb-0">
										...
										<div class="lx-clear-fix"></div>
										<div class="lx-textfield lx-g1 lx-pb-0">
											<label><input type="checkbox" name="columns" value="products" data-title="Détails facture avoir" checked /> Détails facture avoir<del class="checkmark"></del></label>
										</div>
										<div class="lx-clear-fix"></div>
										<div class="lx-textfield lx-g1 lx-pb-0">
										...
										<div class="lx-clear-fix"></div>
										<div class="lx-textfield lx-g1 lx-pb-0">
											<label><input type="checkbox" name="columns" value="state" data-title="Status de remboursement" checked /> Status de remboursement<del class="checkmark"></del></label>
										</div>
										<div class="lx-clear-fix"></div>
										<div class="lx-textfield lx-g1 lx-pb-0">
											<label><input type="checkbox" name="columns" value="rest" data-title="Reste à rembourser TCC" checked /> Reste à rembourser TTC<del class="checkmark"></del></label>
										</div>
										<div class="lx-clear-fix"></div>
										<div class="lx-textfield lx-g1 lx-pb-0">
										...
										<div class="lx-clear-fix"></div>
										<div class="lx-textfield lx-g1 lx-pb-0">
											<label><input type="checkbox" name="columns" value="modepayment" data-title="Mode de remboursement" checked /> Mode de remboursement<del class="checkmark"></del></label>
										</div>
										<div class="lx-clear-fix"></div>
										<div class="lx-textfield lx-g1 lx-pb-0">
											<label><input type="checkbox" name="columns" value="conditions" data-title="Conditions de remboursement" checked /> Conditions de remboursement<del class="checkmark"></del></label>
										</div>
										<div class="lx-clear-fix"></div>
										<div class="lx-textfield lx-g1 lx-pb-0">
							...
							<div class="lx-form">
								...
								<div class="lx-add-form">
									<div class="lx-delete-box">
										<p>Voulez vous vraiment supprimer cette facture avoir?</p>
