				...
				<div class="lx-main-content">
					<div class="lx-page-header">
						<nav class="breadcrumb">
							<span class="breadcrumb-item active"><i class="fas fa-reply"></i> Bons de retour</span>
						</nav>
					</div>
					...
					<div class="lx-tabs">
						...
						if(preg_match("#Consulter Bons de retour#",$_SESSION['easybm_roles'])){	
							?>
						<a href="br.php" class="active">Bons de retour</a>
							<?php
						}
						...
						<div class="lx-g1">
							<div class="lx-add-form">
								...
								if(preg_match("#Ajouter Bons de retour#",$_SESSION['easybm_roles'])){	
									?>							
								<a href="javascript:;" class="lx-new lx-new-command lx-open-popup" data-header="Ajouter un nouveau" data-table="br" data-title="command">+ Nouveau bon de retour</a>
									<?php
								}					
								?>						
							</div>
							<div class="lx-keyword">
								<fieldset style="margin-bottom:20px;padding:10px;background:#F8F8F8;">
									...
									<label><a href="javascript:;" class="lx-search-keyword"><i class="fa fa-search"></i></a><input type="text" autocomplete="off" name="keyword" id="keyword" placeholder="Réf bon de retour" data-table="br" /></label>
									<?php
									$styleday = "";
									$rangedate = "";
									...
									<label>
										<a href="br.php" class="lx-refresh-filter" style="margin-left:10px;"><i class="fa fa-sync-alt"></i></a>
									</label>
								</fieldset>
							</div>
							<div class="lx-table-container">
								...
								<div class="lx-table lx-table-br">
							...
							<div class="lx-action-bulk">
								<?php
								if(preg_match("#Exporter Bons de retour#",$_SESSION['easybm_roles'])){
								?>
							...
							<div class="lx-pagination" style="<?php if($row['nb'] <= $nb){echo "display:none;";}?>">
								...
								?>
								<ul data-table="br" data-state="1" data-start="0" data-nbpage="<?php echo $nb;?>" data-posts="<?php echo $row['nb'];?>">
								...
								<div class="lx-add-form">
									<form autocomplete="off" action="#" method="post" id="commandsform">
										...
										<div class="lx-submit lx-g1 lx-pb-0">
											...
											<input type="hidden" name="prefix" value="BR" />
				...
				<div class="lx-popup-inside">
					<div class="lx-popup-content">
						...
						<div class="lx-popup-details">
							<div class="lx-form">
								<div class="lx-form-title">
									<h3>Remboursement bon de retour</h3>
								</div>
								<div class="lx-add-form">
							...
							<div class="lx-form">
								...
								<div class="lx-add-form">
									<form autocomplete="off" action="#" method="post" id="exportform">
										...
										<div class="lx-clear-fix"></div>
										<div class="lx-textfield lx-g1 lx-pb-0">
											<label><input type="checkbox" name="columns" value="products" data-title="Détails bon de retour" checked /> Détails bon de retour<del class="checkmark"></del></label>
										</div>
										<div class="lx-clear-fix"></div>
										<div class="lx-textfield lx-g1 lx-pb-0">
							...
							<div class="lx-form">
								...
								<div class="lx-add-form">
									<div class="lx-delete-box">
										<p>Voulez vous vraiment supprimer cette bon de retour?</p>
