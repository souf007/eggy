				...
				<div class="lx-main-content">
					<div class="lx-page-header">
						<nav class="breadcrumb">
							<span class="breadcrumb-item active"><i class="fas fa-sign-out-alt"></i> Bons de sortie</span>
						</nav>
					</div>
					...
					<div class="lx-tabs">
						...
						if(preg_match("#Consulter Bons de sortie#",$_SESSION['easybm_roles'])){	
							?>
						<a href="bs.php" class="active">Bons de sortie</a>
							<?php
						}
						?>
					</div>
						...
						<div class="lx-g1">
							<div class="lx-add-form">
								...
								if(preg_match("#Ajouter Bons de sortie#",$_SESSION['easybm_roles'])){	
									?>							
								<a href="javascript:;" class="lx-new lx-new-command lx-open-popup" data-header="Ajouter un nouveau" data-table="bs" data-title="command">+ Nouveau bon de sortie</a>
									<?php
								}					
								?>						
							</div>
							<div class="lx-keyword">
								<fieldset style="margin-bottom:20px;padding:10px;background:#F8F8F8;">
									...
									<label><a href="javascript:;" class="lx-search-keyword"><i class="fa fa-search"></i></a><input type="text" autocomplete="off" name="keyword" id="keyword" placeholder="Réf bon de sortie" data-table="bs" /></label>
									<?php
									$styleday = "";
									$rangedate = "";
									...
									<label>
										<a href="bs.php" class="lx-refresh-filter" style="margin-left:10px;"><i class="fa fa-sync-alt"></i></a>
									</label>
								</fieldset>
							</div>
							<div class="lx-table-container">
								...
								<div class="lx-table lx-table-bs">
							...
							<div class="lx-action-bulk">
								<?php
								if(preg_match("#Exporter Bons de sortie#",$_SESSION['easybm_roles'])){
								?>
							...
							<div class="lx-pagination" style="<?php if($row['nb'] <= $nb){echo "display:none;";}?>">
								...
								?>
								<ul data-table="bs" data-state="1" data-start="0" data-nbpage="<?php echo $nb;?>" data-posts="<?php echo $row['nb'];?>">
								...
								<div class="lx-add-form">
									<form autocomplete="off" action="#" method="post" id="commandsform">
										<div class="lx-textfield lx-g1 lx-pb-0 lx-transform">
											<label><span>Duppliquer ou transformer vers:</span>
												<select name="transform">
													<option value="bs" data-prefix="BS">Bons de sortie</option>
													<option value="facture" data-prefix="FA">Facture</option>
													<option value="devis" data-prefix="DE">Devis</option>
													<option value="factureproforma" data-prefix="FP">Facture proforma</option>
													<option value="bl" data-prefix="BL">Bon de livraison</option>
										...
										<div class="lx-submit lx-g1 lx-pb-0">
											...
											<input type="hidden" name="prefix" value="BS" />
							...
							<div class="lx-form">
								...
								<div class="lx-add-form">
									<form autocomplete="off" action="#" method="post" id="exportform">
										...
										<div class="lx-clear-fix"></div>
										<div class="lx-textfield lx-g1 lx-pb-0">
											<label><input type="checkbox" name="columns" value="products" data-title="Détails bon de sortie" checked /> Détails bon de sortie<del class="checkmark"></del></label>
										</div>
										<div class="lx-clear-fix"></div>
										<div class="lx-textfield lx-g1 lx-pb-0">
							...
							<div class="lx-form">
								...
								<div class="lx-add-form">
									<div class="lx-delete-box">
										<p>Voulez vous vraiment supprimer ce bon de sortie?</p>
