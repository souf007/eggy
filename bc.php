				...
				<div class="lx-main-content">
					<div class="lx-page-header">
						<nav class="breadcrumb">
							<span class="breadcrumb-item active"><i class="fas fa-clipboard-list"></i> Bons de commande</span>
						</nav>
					</div>
					...
					<div class="lx-tabs">
						...
						if(preg_match("#Consulter Bons de commande#",$_SESSION['easybm_roles'])){	
							?>
						<a href="bc.php" class="active">Bons de commande</a>
							<?php
						}
						if(preg_match("#Consulter Bons de réception#",$_SESSION['easybm_roles'])){	
							?>
						<a href="bre.php">Bons de réception</a>
							<?php
						}
						?>
					</div>
						...
						<div class="lx-g1">
							<div class="lx-add-form">
								...
								if(preg_match("#Ajouter Bons de commande#",$_SESSION['easybm_roles'])){	
									?>							
								<a href="javascript:;" class="lx-new lx-new-command lx-open-popup" data-header="Ajouter un nouveau" data-table="bc" data-title="command">+ Nouveau bon de commande</a>
									<?php
								}					
								?>						
							</div>
							<div class="lx-keyword">
								<fieldset style="margin-bottom:20px;padding:10px;background:#F8F8F8;">
									...
									<label><a href="javascript:;" class="lx-search-keyword"><i class="fa fa-search"></i></a><input type="text" autocomplete="off" name="keyword" id="keyword" placeholder="Réf bon de commande" data-table="bc" /></label>
									<?php
									$styleday = "";
									$rangedate = "";
									...
									$startdate = "";
									$enddate = "";
									if(preg_match("#Consultation de la journée en cours seulement Bons de commande#",$_SESSION['easybm_roles'])){
									...
									<label class="lx-advanced-select">
										<i class="fa fa-caret-down"></i>
										<input type="text" autocomplete="off" name="state" id="state" title="État de paiement" value="<?php echo isset($_GET['paid'])?$_GET['paid']:"";?>" placeholder="État de paiement" data-ids="<?php echo isset($_GET['padi'])?$_GET['padi']:"";?>" readonly />
										<div>
											<a href="javascript:;" class="lx-state-empty">Vider</a>
											<a href="javascript:;" class="lx-state-filter">Filtrer</a>
											<div class="lx-clear-fix"></div>
									...
									<label>
										<a href="bc.php" class="lx-refresh-filter" style="margin-left:10px;"><i class="fa fa-sync-alt"></i></a>
									</label>
								</fieldset>
							</div>
							<div class="lx-table-container">
								...
								<div class="lx-table lx-table-bc">
							...
							<div class="lx-action-bulk">
								<?php
								if(preg_match("#Exporter Bons de commande#",$_SESSION['easybm_roles'])){
								?>
							...
							<div class="lx-pagination" style="<?php if($row['nb'] <= $nb){echo "display:none;";}?>">
								...
								?>
								<ul data-table="bc" data-state="1" data-start="0" data-nbpage="<?php echo $nb;?>" data-posts="<?php echo $row['nb'];?>">
								...
								<div class="lx-add-form">
									<form autocomplete="off" action="#" method="post" id="commandsform">
										...
										<div class="lx-submit lx-g1 lx-pb-0">
											...
											<input type="hidden" name="prefix" value="BC" />
