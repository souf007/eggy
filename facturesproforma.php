	...
	<body>
				...
				<div class="lx-main-content">
					<div class="lx-page-header">
						<nav class="breadcrumb">
							<span class="breadcrumb-item active"><i class="fas fa-file-contract"></i> Factures proforma</span>
						</nav>
					</div>
					...
					<div class="lx-tabs">
						...
						if(preg_match("#Consulter Factures proforma#",$_SESSION['easybm_roles'])){
							?>
						<a href="facturesproforma.php" class="active">Factures proforma</a>
							<?php
						}
						...
						<div class="lx-g1">
							<div class="lx-add-form">
								...
								if(preg_match("#Ajouter Factures proforma#",$_SESSION['easybm_roles'])){	
									?>							
								<a href="javascript:;" class="lx-new lx-new-command lx-open-popup" data-header="Ajouter un nouvelle" data-table="facturesproforma" data-title="command">+ Nouvelle facture proforma</a>
									<?php
								}					
								?>						
							</div>
							<div class="lx-keyword">
								<fieldset style="margin-bottom:20px;padding:10px;background:#F8F8F8;">
									...
									<label><a href="javascript:;" class="lx-search-keyword"><i class="fa fa-search"></i></a><input type="text" autocomplete="off" name="keyword" id="keyword" placeholder="Réf facture proforma" data-table="facturesproforma" /></label>
									<?php
									$styleday = "";
									$rangedate = "";
									...
									<label>
										<a href="facturesproforma.php" class="lx-refresh-filter" style="margin-left:10px;"><i class="fa fa-sync-alt"></i></a>
									</label>
								</fieldset>
							</div>
							<div class="lx-table-container">
								...
								<div class="lx-table lx-table-facturesproforma">
							...
							<div class="lx-action-bulk">
								<?php
								if(preg_match("#Exporter Factures proforma#",$_SESSION['easybm_roles'])){
								?>
							...
							<div class="lx-pagination" style="<?php if($row['nb'] <= $nb){echo "display:none;";}?>">
								...
								?>
								<ul data-table="facturesproforma" data-state="1" data-start="0" data-nbpage="<?php echo $nb;?>" data-posts="<?php echo $row['nb'];?>">
						...
						<div class="lx-popup-details">
							<div class="lx-form">
								<div class="lx-form-title">
									<h3><span></span> facture proforma</h3>
								</div>
								<div class="lx-add-form">
									<form autocomplete="off" action="#" method="post" id="commandsform">
										<div class="lx-textfield lx-g1 lx-pb-0 lx-transform">
											<label><span>Duppliquer ou transformer vers:</span>
												<select name="transform">
													<option value="factureproforma" data-prefix="PF">Factures proforma</option>
													<option value="facture" data-prefix="FA">Facture</option>
													<option value="devis" data-prefix="DE">Devis</option>
													<option value="bl" data-prefix="BL">Bon de livraison</option>
													<option value="bs" data-prefix="BS">Bon de sortie</option>
										...
										<div class="lx-submit lx-g1 lx-pb-0">
											...
											<input type="hidden" name="type" value="factureproforma" />
											<input type="hidden" name="prefix" value="PF" />
				...
				<div class="lx-popup-inside">
					<div class="lx-popup-content">
						...
						<div class="lx-popup-details">
							<div class="lx-form">
								<div class="lx-form-title">
									<h3>Export factures proforma</h3>
								</div>
								<div class="lx-add-form">
									<form autocomplete="off" action="#" method="post" id="exportform">
										...
										<div class="lx-clear-fix"></div>
										<div class="lx-textfield lx-g1 lx-pb-0">
											<label><input type="checkbox" name="columns" value="products" data-title="Détails facture proforma" checked /> Détails facture proforma<del class="checkmark"></del></label>
										</div>
										<div class="lx-clear-fix"></div>
										<div class="lx-textfield lx-g1 lx-pb-0">
							...
							<div class="lx-form">
								...
								<div class="lx-add-form">
									<div class="lx-delete-box">
										<p>Voulez vous vraiment supprimer cette facture proforma?</p>
		...
		<script>
			$(document).ready(function(){
				...
				loadPriceRange("factureproforma");
				toDropDown();
			});
			$(function() {
